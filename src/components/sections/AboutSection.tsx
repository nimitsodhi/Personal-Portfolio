...
const skills = [
  { label: 'Html', color: 'bg-cyan-500/20 text-cyan-400 border-cyan-500/30' },
  { label: 'Python', color: 'bg-blue-500/20 text-blue-400 border-blue-500/30' },
  { label: 'Javascript', color: 'bg-white/10 text-white border-white/20' },
  { label: 'Java', color: 'bg-pink-500/20 text-pink-400 border-pink-500/30' },
  { label: 'CSS', color: 'bg-green-500/20 text-green-400 border-green-500/30' },
